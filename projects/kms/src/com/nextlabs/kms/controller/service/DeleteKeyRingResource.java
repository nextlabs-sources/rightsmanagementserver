...
public class DeleteKeyRingResource extends ServerResource {
	...
	public Representation doPost(Representation entity) throws IOException {	
		...
		DeleteKeyRingResponse keyRingResponse = factory.createDeleteKeyRingResponse();
		DeleteKeyRingRequest keyRingRequest = JAXB.unmarshal(new StringReader(entity.getText()), DeleteKeyRingRequest.class);
		String responseXml = "";	
		try {
			...
			keyRingManager.deleteKeyRing(keyRingName);
