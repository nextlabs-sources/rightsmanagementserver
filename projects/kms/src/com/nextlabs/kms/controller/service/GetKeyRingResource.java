...
import com.nextlabs.kms.GetKeyRingRequest;
...
public class GetKeyRingResource extends ServerResource {
	...
	public Representation doPost(Representation entity) throws IOException {	
		...
		GetKeyRingResponse keyRingResponse = factory.createGetKeyRingResponse();
		GetKeyRingRequest keyRingRequest = JAXB.unmarshal(new StringReader(entity.getText()), GetKeyRingRequest.class);
		String responseXml = "";	
		try {
			...
			keyRingResponse.setKeyRing(keyRing);
