...
import com.nextlabs.kms.DisableKeyRingRequest;
import com.nextlabs.kms.DisableKeyRingResponse;
...
public class DisableKeyRingResource extends ServerResource {
	...
	public Representation doPost(Representation entity) throws IOException {	
		...
		DisableKeyRingResponse keyRingResponse = factory.createDisableKeyRingResponse();
		DisableKeyRingRequest keyRingRequest = JAXB.unmarshal(new StringReader(entity.getText()), DisableKeyRingRequest.class);
		String responseXml = "";	
		try {
			...
			keyRingManager.disableKeyRing(keyRingName);
