...
public class JCIFS_NTLMScheme implements AuthScheme {
	   ...
	   private static Logger logger = Logger.getLogger(JCIFS_NTLMScheme.class);
       ...
       private class NTLM {
           ...
           private String credentialCharset = DEFAULT_CHARSET;
              ...
              private String generateType3Msg(String username, String password, String host,
                     ...
                     jcifs.ntlmssp.Type3Message t3m = new jcifs.ntlmssp.Type3Message(t2m, password, domain,username, host,0x00);
