...
public class TCCredentialManager implements CredentialManager {
	...
	public int getCredentialType() {
		return CredentialManager.CLIENT_CREDENTIAL_TYPE_SSO;
	}
	...
	public String[] getCredentials(InvalidCredentialsException e)
		...
		throw new CanceledOperationException("Invalid credentials");
	}
	...
	public String[] getCredentials(InvalidUserException e)
		...
		if (name == null)
			throw new CanceledOperationException("Invalid user");
